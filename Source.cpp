...
int main() {
	...
	cv::VideoCapture vidFile = cv::VideoCapture("D:\\Sensitive_Data\\201609211136-Boomer_Dox1_Treadmill\\decrypted\\201609211136-Boomer_Dox1_Treadmill_Ultraviolet_10-1_RAW.avi");
	vidFile.grab();			// open image
	vidFile.retrieve(matOriginal);
